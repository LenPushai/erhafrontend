...
public class RFQ {
    ...
    public RFQSource getSource() {
        return source;
    }
    
    public void setSource(RFQSource source) {
        this.source = source;
    }
    ...
    public Boolean getConvertedToQuote() {
        return convertedToQuote;
    }
    
    public void setConvertedToQuote(Boolean convertedToQuote) {
        this.convertedToQuote = convertedToQuote;
    }
