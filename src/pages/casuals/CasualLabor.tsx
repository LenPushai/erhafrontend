...
const API_BASE = ((import.meta.env.VITE_API_BASE_URL || 'http://localhost:8080') + '/api/v1/casuals') as string;
const JOBS_API = ((import.meta.env.VITE_API_BASE_URL || 'http://localhost:8080') + '/api/v1/jobs') as string;
