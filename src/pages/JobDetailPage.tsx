...
export function JobDetailPage({ jobId, onBack, onEdit, onAddChildJob, onViewChildJob }: JobDetailPageProps) {
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500">{job.client_name || 'No client'} {job.job_phase && `• ${job.job_phase}`}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xl font-bold text-gray-900">R {(job.quoted_value || totalValue).toLocaleString()}</p>
