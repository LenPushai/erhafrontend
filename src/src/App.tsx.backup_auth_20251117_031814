  ...
  return (
      <Routes>
        <Route path="/" element={<MainLayout />}>
          ...
          <Route path="reports" element={<div className="text-center p-5"><h3>Reports Module - Coming Soon</h3></div>} />
          <Route path="settings" element={<div className="text-center p-5"><h3>Settings Module - Coming Soon</h3></div>} />
